...
function Info(props){
    ...
    return(
        <div>
            ...
            <img src={`https://open.mapquestapi.com/staticmap/v4/getmap?key=aRnYU9tKUGKyRp9XYVAyS1V6Tcke5mAD&size=600,400&zoom=5&center=${props.meteor.reclat},${props.meteor.reclong}&pois=1,${props.meteor.reclat},${props.meteor.reclong},-20,-20`} alt={props.meteor.name}/>
        </div>
    );
};
